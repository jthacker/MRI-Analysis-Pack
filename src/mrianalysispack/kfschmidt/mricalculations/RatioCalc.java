...
public class RatioCalc extends MRICalculation {
	...
	public void doCalculation() {
		try {
			...
			double[][][][] ratio = getRatioMap(scan, Integer.parseInt(mBaseLineStart.getText()), Integer.parseInt(mBaseLineStop.getText()),
					Integer.parseInt(mStimStart.getText()), Integer.parseInt(mStimStop.getText()));
			// send the images back to imagej
			String name = ijada.getNameForImageId(mScanChooser.getSelectedIJId()) + "_RATIO";
